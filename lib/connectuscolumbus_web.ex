defmodule ConnectuscolumbusWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: ConnectuscolumbusWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/connectuscolumbus_web/templates",
        namespace: ConnectuscolumbusWeb
      ...
      import ConnectuscolumbusWeb.BreadcrumbsHelpers
      alias ConnectuscolumbusWeb.Router.Helpers, as: Routes
    end
  end
